...
const botaoBuscar = document.getElementById("btnBusscar");
...
botaoBuscar.addEventlistener("click", async function(){
    ...
    if (dados.cod === "404"){divResultado.innerHTML = "<p>Cidade não encontrada.</p>"
        return;}
        

    divResultado.innerHTML = `<div> class="card-clima"
            <h3>${dados.name}</h3>
